...
#---------------------------------------------------------------------------------
#For example:
#Comparison: STAT5_High_VS_STAT5_Low
#Output Folders: Output_DiffExp_1a, Output_DiffExp_1b, Output_DiffExp_1c
#Comparison: Hypox_30min_VS_Hypox_male
#Output Folders: Output_DiffExp_2a, Output_DiffExp_2b, Output_DiffExp_2c
#Comparison: Hypox_90min_VS_Hypox_male
#Output Folders: Output_DiffExp_3a, Output_DiffExp_3b, Output_DiffExp_3c
#---------------------------------------------------------------------------------
COMPAR_NUM=TEMPLATE
##################################################################################
##################################################################################
