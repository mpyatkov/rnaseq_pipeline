...
ExonCollapsed_File=$(ls *'DESeq_'${COUNT_PROGRAM}'.txt' | grep 'ExonCollapsed')
...
paste ${ExonCollapsed_File} ${GeneBody_File} ${Intronic_Only_File} ${Exonic_Only_File} > ${DESEQ_OUTPUT_FILE}
#---------------------------------------------------------------------------------
#Need to paste files together in the following order:
#<GeneBody> <Intronic_Only> <Exonic_Only>
ExonCollapsed_File=$(ls *'EdgeR_'${COUNT_PROGRAM}'.txt' | grep 'ExonCollapsed')
...
#DESeq down files:
DESeq_Down_File1=$(ls Down_Genes_DESeq_LncRNA_ExonCollapsed*)
DESeq_Down_File2=$(ls Down_Genes_DESeq_LncRNA_GeneBody*)
DESeq_Down_File3=$(ls Down_Genes_DESeq_LncRNA_Exonic_Only*)
DESeq_Down_File4=$(ls Down_Genes_DESeq_LncRNA_Intronic_Only*)
...
echo ${DESeq_Down_File3}
echo 'DESeq_Down_File4:'
echo ${DESeq_Down_File4}
echo '#--------------------------------------------------------------------------'
Rscript Venn_Count_Method.R ${DESeq_Down_File1} ${DESeq_Down_File2} ${DESeq_Down_File3} ${DESeq_Down_File4}
echo '#--------------------------------------------------------------------------'
#DESeq up files:
DESeq_Up_File1=$(ls Up_Genes_DESeq_LncRNA_ExonCollapsed*)
DESeq_Up_File2=$(ls Up_Genes_DESeq_LncRNA_GeneBody*)
DESeq_Up_File3=$(ls Up_Genes_DESeq_LncRNA_Exonic_Only*)
DESeq_Up_File4=$(ls Up_Genes_DESeq_LncRNA_Intronic_Only*)
echo 'Input files for Venn_Count_Method.R:'
echo 'DESeq_Up_File1:'
echo ${DESeq_Up_File1}
echo 'DESeq_Up_File2:'
...
echo ${DESeq_Up_File4}
echo '#--------------------------------------------------------------------------'
Rscript Venn_Count_Method.R ${DESeq_Up_File1} ${DESeq_Up_File2} ${DESeq_Up_File3} ${DESeq_Up_File4}
echo '#--------------------------------------------------------------------------'
#EdgeR down files:
EdgeR_Down_File1=$(ls Down_Genes_EdgeR_LncRNA_ExonCollapsed*)
EdgeR_Down_File2=$(ls Down_Genes_EdgeR_LncRNA_GeneBody*)
EdgeR_Down_File3=$(ls Down_Genes_EdgeR_LncRNA_Exonic_Only*)
EdgeR_Down_File4=$(ls Down_Genes_EdgeR_LncRNA_Intronic_Only*)
echo 'Input files for Venn_Count_Method.R:'
...
echo ${EdgeR_Down_File3}
echo 'EdgeR_Down_File4:'
echo ${EdgeR_Down_File4}
echo '#--------------------------------------------------------------------------'
Rscript Venn_Count_Method.R ${EdgeR_Down_File1} ${EdgeR_Down_File2} ${EdgeR_Down_File3} ${EdgeR_Down_File4}
echo '#--------------------------------------------------------------------------'
#EdgeR up files:
EdgeR_Up_File1=$(ls Up_Genes_EdgeR_LncRNA_ExonCollapsed*)
EdgeR_Up_File2=$(ls Up_Genes_EdgeR_LncRNA_GeneBody*)
EdgeR_Up_File3=$(ls Up_Genes_EdgeR_LncRNA_Exonic_Only*)
EdgeR_Up_File4=$(ls Up_Genes_EdgeR_LncRNA_Intronic_Only*)
echo 'Input files for Venn_Count_Method.R:'
echo 'EdgeR_Up_File1:'
echo ${EdgeR_Up_File1}
echo 'EdgeR_Up_File2:'
...
echo ${EdgeR_Up_File4}
echo '#--------------------------------------------------------------------------'
Rscript Venn_Count_Method.R ${EdgeR_Up_File1} ${EdgeR_Up_File2} ${EdgeR_Up_File3} ${EdgeR_Up_File4} 
echo '#--------------------------------------------------------------------------'
echo 'Create montage of PNG files'
