...
# DiffExp_Output <- "Male_G83_M1M2_vs_Female_G83_M3M4_ExonCollapsed_forSEGEXUpload_DESeq.txt"
# fold_change_cutoff <- 2
# padj_cutoff <- 0.05
# postfix <- "LncRNA_ExonCollapsed"
...
# > colnames(DiffExp_data)
# [1] "id.LncRNA_ExonCollapsed"               "ratio.LncRNA_ExonCollapsed"            "foldChange.LncRNA_ExonCollapsed"      
# [4] "rpkm_mean_Female.LncRNA_ExonCollapsed" "rpkm_mean_Male.LncRNA_ExonCollapsed"   "padj.LncRNA_ExonCollapsed"            
# [7] "pval.LncRNA_ExonCollapsed"
############################################################
