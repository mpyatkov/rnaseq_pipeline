...
if(grepl("Exon|ExonCollapsed", File1_Name, ignore.case = FALSE)) {
  feature_counted <- "ExonCollapsed"
}

if(grepl("Exon_Only|Exonic_Only", File1_Name, ignore.case = FALSE)) {
...
#End of if statement
if(grepl("Intron|Intronic_Only", File1_Name, ignore.case = FALSE)) {
...
#End of if statement
if(grepl("Exon|ExonCollapsed", File2_Name, ignore.case = FALSE)) {
  feature_counted <- "ExonCollapsed"
}

if(grepl("Exon_Only|Exonic_Only", File2_Name, ignore.case = FALSE)) {
feature_counted <- "Exonic_Only"
}
...
#End of if statement
if(grepl("Intron|Intronic_Only", File2_Name, ignore.case = FALSE)) {
feature_counted <- "Intronic_Only"
}
